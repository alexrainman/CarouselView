...
void xamarin_create_classes () {
	...
	__xamarin_class_map [100].handle = objc_getClass ("UILongPressGestureRecognizer");
	__xamarin_class_map [101].handle = objc_getClass ("UITapGestureRecognizer");
	__xamarin_class_map [102].handle = objc_getClass ("UIPanGestureRecognizer");
	__xamarin_class_map [103].handle = objc_getClass ("UIPinchGestureRecognizer");
	...
	__xamarin_class_map [109].handle = objc_getClass ("UIPageViewController");
